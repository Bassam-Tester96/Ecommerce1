...
//        driver.findElement(By.id("Password")).sendKeys(Keys.ENTER);
        ...
        driver.findElement(By.id("small-searchterms")).sendKeys("Build your own computer");
        Thread.sleep(3000);
        ...
        // add assert
        Assert.assertEquals(driver.getCurrentUrl(),"https://demo.nopcommerce.com/build-your-own-computer");
